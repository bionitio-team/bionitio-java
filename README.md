...
```
% bionitio-java -h
Usage: bionitio-java [--minlen N] [--version] [--log FILE] [[FASTA_FILE ...]]
  Print fasta stats
...
```
% bionitio-java file1.fa file2.fa file3.fa
FILENAME	NUMSEQ	TOTAL	MIN	AVG	MAX
file1.fa	5264	3801855	31	722	53540
...
```
% bionitio-java --minlen 1000 file.fa
FILENAME	NUMSEQ	TOTAL	MIN	AVG	MAX
...
```bash
mvn -B archetype:generate -DarchetypeGroupId=org.apache.maven.archetypes -DgroupId=org.supernifty.bionitio -DartifactId=bionitio
```
